...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <h6 class="navbar-brand" class="h-6">Attendance & Leave</h6>
      <li class="nav-item">
        <a class="nav-link" href="/attendance">Dashboard</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/attendance/calendar">Calendar</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/attendance/reports">Reports</a>
      </li>
    </ul>
